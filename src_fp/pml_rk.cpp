...
__global__ void wave_pml_rk0( FLOAT * h_W, FLOAT * W, FLOAT * t_W, FLOAT * m_W, long long WStride )
{
...
__global__ void wave_pml_rk1( FLOAT * h_W, FLOAT * W, FLOAT * t_W, FLOAT * m_W, long long WStride )
{
	long long i = threadIdx.x + blockIdx.x * blockDim.x;
...
__global__ void wave_pml_rk2( FLOAT * h_W, FLOAT * W, FLOAT * t_W, FLOAT * m_W, long long WStride )
{
	long long i = threadIdx.x + blockIdx.x * blockDim.x;
...
__global__ void wave_pml_rk3( FLOAT * h_W, FLOAT * W, FLOAT * t_W, FLOAT * m_W, long long WStride )
{
	long long i = threadIdx.x + blockIdx.x * blockDim.x;
...
__global__ void new_pml_rk( FLOAT * const h_W, FLOAT * const W, const long long WStride, const float B, const float DT )
{
