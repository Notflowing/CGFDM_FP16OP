...
/*
 * Initialize grid
 * The global grid is divided into sub-grids by MPI
 * The size of each MPI sub-grid can be different
 * because of the remainder of the global grid and MPI partition
 */
