...
# ################## 4 GPU ##################
# nvidia-smi --format=csv -i 4,5,6,7 -lms 10 -f profilersDir/profile_fp32.log \
#     --query-gpu=count,gpu_name,index,memory.total,memory.used,utilization.gpu,utilization.memory,power.management,power.draw

# nvidia-smi --format=csv -i 4,5,6,7 -lms 10 -f profilersDir/profile_fp16.log \
#     --query-gpu=count,gpu_name,index,memory.total,memory.used,utilization.gpu,utilization.memory,power.management,power.draw

# nvidia-smi --format=csv -i 4,5,6,7 -lms 10 -f profilersDir/profile_half2.log \
#     --query-gpu=count,gpu_name,index,memory.total,memory.used,utilization.gpu,utilization.memory,power.management,power.draw
